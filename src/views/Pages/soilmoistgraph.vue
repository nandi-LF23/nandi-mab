                    ...
                    <card body-classes="px-0 py-0">
                        <template slot="header">
                            <div class='row'>
                                <div class='col-md-12'>
                                    <base-button
                                        :disabled="!node_id || !userCan('Export', 'Soil Moisture', node_id, 'O') || loading"
                                    ...
                                    <base-button
                                        :disabled="!node_id || !userCan('Edit', 'Soil Moisture', node_id, 'O') || loading"
                                        @click.native="goToManage()" class="btn" size="sm" type="primary"
                                        v-b-tooltip.hover.top title="Navigate to the soil moisture node's management screen"
                                        icon>
                                        Manage SM
                                    </base-button>
                                </div>
                        ...
                        <div class="card-body">
                                        ...
                                        <el-select v-model="current_node" :disabled="loading">
                                            <template v-for="(node, index) in related_nodes">
                                                <el-option :key="index" :label="node" :value="node"
                                                    :selected="$route.params.node_address">
                                                </el-option>
                                            </template>
                                        </el-select>
                                    </base-input>
                            ...
                            <b-row>
                                <b-col class='text-center'>
                                    ...
                                    <b-form-checkbox v-if="graph_type == 'stack'" @change="toggleSeriesDragDrop"
                                        v-model="zoomOrDrag" size="lg" switch>Mode: {{ zoomOrDrag ? "Drag" : "Zoom" }}
                                    </b-form-checkbox>
                                </b-col>
