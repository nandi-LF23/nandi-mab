...
$sql = 'SELECT * FROM node_data_meter ORDER BY idwm DESC LIMIT 1';
...
$sql_1 = 'SELECT COUNT(*) as total FROM node_data_meter WHERE message_id = \''.$body->uplinks[$j]->messageId.'\'';
//echo $sql_1;
...
$sql = 'INSERT into node_data_meter (date_time,node_id,batt_volt,message_id, deg_c, power_state, pulse_1, pulse_2, state_of_measure_1, state_of_measure_2, pulse_1_mA, pulse_2_mA,ultrasonic)';
