...
*/
            $NO3_avg += ($dataset->M3_1 * $poly1) + $poly2;
            $NH4_avg += ($dataset->M3_2 * $poly1) + $poly2;
            $NO3_avg += ($dataset->M3_3 * $poly1) + $poly2;
            $NH4_avg += ($dataset->M3_4 * $poly1) + $poly2;

            $NO3_avg += ($dataset->M4_1 * $poly1) + $poly2;
            $NH4_avg += ($dataset->M4_2 * $poly1) + $poly2;
            $NO3_avg += ($dataset->M4_3 * $poly1) + $poly2;
            $NH4_avg += ($dataset->M4_4 * $poly1) + $poly2;

            $NO3_avg += ($dataset->M5_1 * $poly1) + $poly2;
            $NH4_avg += ($dataset->M5_2 * $poly1) + $poly2;
            $NO3_avg += ($dataset->M5_3 * $poly1) + $poly2;
            $NH4_avg += ($dataset->M5_4 * $poly1) + $poly2;

            $NO3_avg += ($dataset->M6_1 * $poly1) + $poly2;
            $NH4_avg += ($dataset->M6_2 * $poly1) + $poly2;
            $NO3_avg += ($dataset->M6_3 * $poly1) + $poly2;
            $NH4_avg += ($dataset->M6_4 * $poly1) + $poly2;
            ...
            $results['nutrient_NH4']   = (float)$NH4_avg; /* ACTUAL VALUE */
            $results['nutrient_NO3']   = (float)$NO3_avg; /* ACTUAL VALUE */
            $results['nutrient_ppm']   = (float)$ppm_avg; /* ACTUAL VALUE */
