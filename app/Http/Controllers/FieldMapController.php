    ...
    public function index(Request $request)
    {
        ...
        foreach ($nodes as $index => &$node) {
            ...
            $defaults = [
                ...
                'base_node_address' => substr($node_address, 0, strpos($node_address, '-')),
                // chop off probe number
                'date_time' => "No data.",
                'date_diff' => '',
                'sort_date' => 0,
                'field_name' => 'Field',
                ...
                'layer' => [
                    ...
                    // Soil Moisture is default visible layer
...
$NO3_avg = 0;
                        ...
                        if ($dataset->count() > 0) {
                            ...
                            $data['gauge_value'] = number_format(($counter1 + $counter2) ? ($NO3_avg + $NH4_avg) / ($counter1 + $counter2) : 0, 1, '.', '');
                            $data['nutrient_lower'] = 0;
                            $data['nutrient_upper'] = 0;
                            $data['nutrient_gauge'] = 0;
                            $data['nutrient_avg'] = 0;
