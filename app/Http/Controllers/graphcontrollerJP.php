...
class GraphController extends Controller
{
    ...
    public function sm_graph(Request $request)
    {
        ...
        $graph_type = !empty($graph_type) && $hwconfig->node_type == 'Nutrients' && !in_array($graph_type, ['nutrient', 'nutrient_ppm', 'nutrient_type_avg', 'nutrient_sm_avg', 'nutrient_temp_avg']) ? 'nutrient_type_avg' : $graph_type;
        ...
        if (in_array($graph_type, ['sum', 'ave', 'temp', 'sm', 'stack', 'tech'])) {
            ...
            $node_data = $query->get();
        } else if (in_array($graph_type, ['nutrient', 'nutrient_ppm', 'nutrient_type_avg', 'nutrient_sm_avg', 'nutrient_temp_avg'])) {
...
*/
                ...
                if (!empty($field->nutrient_template_id) && $field->nutrient_template_id) {
                    ...
                    $graph_data['nutrient_NH4']   = (float) number_format($NH4_avg, 1, '.', '');
                }
