...
class NodeStartupInfo extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql_root')->create('node_startup_info', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('mysql_root')->drop('node_startup_info');
    }
}
